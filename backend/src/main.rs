use postgres::{ Client, NoTls }; //Connection db sans TLS
use postgres::Error as PostgresError; 
use std::net::{ TcpListener, TcpStream }; // Creer tcp server
use std::io::{ Read, Write }; //Lire et ecrire sur le stream
use std::env;
...
struct User {
    id: Option<i32>, //id est optionnel car on ne le passe pas quand on cree/modifie un user
    name: String,
    email: String,
}
